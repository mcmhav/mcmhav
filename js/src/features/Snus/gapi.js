...
(function() {
  ...
  var da = /^(\/[a-zA-Z0-9_\-]+)+$/,
    ...
    la = function(a, b, c, d) {
      ...
      b = k;
      c = b.match(ia);
      ((d = b.match(ja)) && 1 === d.length && ka.test(b) && c && 1 === c.length) ||
        N('failed sanity: ' + a);
      return k;
    },
    na = function(a, b, c, d) {
      ...
      return void 0 !== a
        ...
        ? (a = h.querySelector('script[nonce]'))
          ? ((a = a.nonce || a.getAttribute('nonce') || ''),
            a && a === String(a) && a.match(S) ? (A.nonce = a) : (A.nonce = null))
          : null
        : null;
    },
    pa = function(a) {
...
gapi.load('', {
  ...
  _c: {
    jsl: {
      ...
      h:
        'm;/_/scs/apps-static/_/js/k\u003doz.gapi.en.COaYzTRXlXk.O/am\u003dQQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCMWUg7n4WrJDPw_obRv3Lg7jd5-FA/m\u003d__features__',
